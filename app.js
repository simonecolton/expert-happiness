const Manager = require("./Assets/Roles/Manager");
const Engineer = require("./Assets/Roles/Engineer");
const Intern = require("./Assets/Roles/Intern");
...
const render = require("./Assets/Roles/htmlRenderer");
